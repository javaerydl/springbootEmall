...
import com.qujiali.springboot.common.exception.AuthException;
import com.qujiali.springboot.common.exception.Resources;
import com.qujiali.springboot.common.support.Token;
...
public abstract class Assert {
    ...
    public static void isTrueServerError(boolean expression, String key, Object... args) {
        if (!expression) {
            throw new ServerErrorException(getMessage(key, args));
        }
    }

    public static void isFalseServerError(boolean expression, String key, Object... args) {
        if (expression) {
            throw new ServerErrorException(getMessage(key, args));
        }
    }

    public static void notNullServerError(Object object, String key, Object... args) {
    ...
    public static Long currentUserId(HttpServletRequest request) {
        String userId = request.getHeader("onlyID");
...
/*    public static String phone(String phone) {
    ...
    public static void isError(Object object, String key, Object... args) {
        if (object.equals(Constants.ERROE)) {
            throw new IllegalArgumentException(getMessage(key + "_IS_ERROR", args));
        }
    }
    ...
    public static void serverError(String key, Object... args) {
        throw new ServerErrorException(getMessage(key, args));
    }
